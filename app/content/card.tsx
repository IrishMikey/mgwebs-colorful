...
export default function WorkCard({ title, card, desc, modal }: WorkProps) {
  ...
  return (
    ...
    >
      <Card className="group relative max-w-[42rem] overflow-hidden last:mb-0 sm:mb-2 sm:h-[18rem]">
        ...
        <Image
          ...
          alt={card.alt}
          quality={95}
          className="group-even:-right-inital shadow-black-800 group-hover:scale-[1.04 absolute -right-40 top-8 w-[28.25rem] rounded-t-lg shadow-md transition group-even:-left-40 group-hover:-translate-x-3 group-hover:translate-y-3 group-hover:-rotate-2
